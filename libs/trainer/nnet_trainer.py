...
class NNetTrainer(base_trainer.BaseTrainer):
    ...
    def build_dataloader(self): 
        ...
        if self.train_opts['loss'] == 'TripletLoss':
            ...
            self.trainloader = DataLoader(self.trainset, collate_fn = train_collate_fn, batch_sampler = batch_sampler, prefetch_factor = 5,
            ...
            self.trainloader = DataLoader(self.trainset, shuffle = True, collate_fn = train_collate_fn, batch_sampler = batch_sampler, 
                                          batch_size = self.train_opts['bs'] * self.device_num, prefetch_factor = 5, num_workers = cpu_count)
